<p align="center">
  <img src="assets/banner.svg" alt="Awesome Agricultural Carbon Management Banner" width="100%">
</p>
...
* **[Crop-Yield-Prediction-Using-Satellite-Imagery](https://github.com/meet-sapu/Crop-Yield-Prediction-Using-Satellite-Imagery)** [![Stars](https://img.shields.io/github/stars/meet-sapu/Crop-Yield-Prediction-Using-Satellite-Imagery?style=social&color=white)](https://github.com/meet-sapu/Crop-Yield-Prediction-Using-Satellite-Imagery/stargazers) 🛰️  
...
* **[Satip](https://github.com/openclimatefix-archives/Satip)** [![Stars](https://img.shields.io/github/stars/openclimatefix-archives/Satip?style=social&color=white)](https://github.com/openclimatefix-archives/Satip/stargazers) ☁️  
...
* **[Crop Yield Prediction via Weather & NDVI](https://github.com/abhiwagh95/Crop-yield-prediction-using-weather-data-and-NDVI-time-series)** [![Stars](https://img.shields.io/github/stars/abhiwagh95/Crop-yield-prediction-using-weather-data-and-NDVI-time-series?style=social&color=white)](https://github.com/abhiwagh95/Crop-yield-prediction-using-weather-data-and-NDVI-time-series/stargazers) 📊  
...
* **[FAO SOC Mapping Cookbook](https://github.com/FAO-SID/SOC-Mapping-Cookbook)** [![Stars](https://img.shields.io/github/stars/FAO-SID/SOC-Mapping-Cookbook?style=social&color=white)](https://github.com/FAO-SID/SOC-Mapping-Cookbook/stargazers) 📖  
...
* **[DVM-DOS-TEM](https://github.com/uaf-arctic-eco-modeling/dvm-dos-tem)** [![Stars](https://img.shields.io/github/stars/uaf-arctic-eco-modeling/dvm-dos-tem?style=social&color=white)](https://github.com/uaf-arctic-eco-modeling/dvm-dos-tem/stargazers) 🌲  
  *Process-based Dynamic Vegetation, Dynamic Organic Soil, Terrestrial Ecosystem Model for ecosystem carbon flux modeling.*

* **[Crop Yield Prediction Remote Sensing](https://github.com/Beckybams/Crop-Yield-Prediction-with-Remote-Sensing-)** [![Stars](https://img.shields.io/github/stars/Beckybams/Crop-Yield-Prediction-with-Remote-Sensing-?style=social&color=white)](https://github.com/Beckybams/Crop-Yield-Prediction-with-Remote-Sensing-/stargazers) 🌾  
  *Estimates agricultural productivity using satellite vegetation indices, weather patterns, and soil feature engineering.*

* **[EY Crop Forecasting Challenge](https://github.com/association-rosia/crop-forecasting)** [![Stars](https://img.shields.io/github/stars/association-rosia/crop-forecasting?style=social&color=white)](https://github.com/association-rosia/crop-forecasting/stargazers) 🍚  
  *Integration of Microsoft Planetary Computer satellite images and meteorological data for predicting paddy rice yields.*

* **[SOC-DRaHR](https://github.com/ISCN/SOC-DRaHR)** [![Stars](https://img.shields.io/github/stars/ISCN/SOC-DRaHR?style=social&color=white)](https://github.com/ISCN/SOC-DRaHR/stargazers) 🧪  
...
* **[CNN-LSTM for Digital Soil Mapping](https://github.com/zlxy9892/CNN-LSTM_for_DSM)** [![Stars](https://img.shields.io/github/stars/zlxy9892/CNN-LSTM_for_DSM?style=social&color=white)](https://github.com/zlxy9892/CNN-LSTM_for_DSM/stargazers) 🧠  
...
* **[ML Digital Soil Carbon Mapping](https://github.com/chinilin/SOC)** [![Stars](https://img.shields.io/github/stars/chinilin/SOC?style=social&color=white)](https://github.com/chinilin/SOC/stargazers) 🗺️  
...
* **[Satellite Rice Yield Estimation](https://github.com/nimaa66/Crop-Yield-Estimation)** [![Stars](https://img.shields.io/github/stars/nimaa66/Crop-Yield-Estimation?style=social&color=white)](https://github.com/nimaa66/Crop-Yield-Estimation/stargazers) 🌾  
...
* **[Farmland Anomalies Segmentation](https://github.com/amogh7joshi/farmland-anomalies)** [![Stars](https://img.shields.io/github/stars/amogh7joshi/farmland-anomalies?style=social&color=white)](https://github.com/amogh7joshi/farmland-anomalies/stargazers) 🛰️  
  *Computer vision segmentation of destructive farmland anomalies from satellite imagery to safeguard crop yields.*

* **[Soils Revealed Platform](https://github.com/Vizzuality/soils-revealed)** [![Stars](https://img.shields.io/github/stars/Vizzuality/soils-revealed?style=social&color=white)](https://github.com/Vizzuality/soils-revealed/stargazers) 🌏  
...
* **[Soil Carbon Statistics Simulator](https://github.com/spertus/soil-carbon-statistics)** [![Stars](https://img.shields.io/github/stars/spertus/soil-carbon-statistics?style=social&color=white)](https://github.com/spertus/soil-carbon-statistics/stargazers) 📐  
...
* **[Soil Spectroscopy SOC Prediction](https://github.com/eupassarinho/soil-carbon-and-spectroscopy-with-PLS-and-LASSO)** [![Stars](https://img.shields.io/github/stars/eupassarinho/soil-carbon-and-spectroscopy-with-PLS-and-LASSO?style=social&color=white)](https://github.com/eupassarinho/soil-carbon-and-spectroscopy-with-PLS-and-LASSO/stargazers) 🔬  
...
* **[AgroVision Precision Ag](https://github.com/mwasifanwar/agrovision-precision)** [![Stars](https://img.shields.io/github/stars/mwasifanwar/agrovision-precision?style=social&color=white)](https://github.com/mwasifanwar/agrovision-precision/stargazers) 🛸  
  *Multispectral drone and satellite computer vision pipelines monitoring soil health, crop disease, and yield prediction.*

* **[Open Farm Carbon Tracker](https://github.com/euraf/OpenFarmCarbonTracker)** [![Stars](https://img.shields.io/github/stars/euraf/OpenFarmCarbonTracker?style=social&color=white)](https://github.com/euraf/OpenFarmCarbonTracker/stargazers) 🚜  
...
* **[Carbon MRV Prototype](https://github.com/atnahm/Carbon-MRV-Prototype)** [![Stars](https://img.shields.io/github/stars/atnahm/Carbon-MRV-Prototype?style=social&color=white)](https://github.com/atnahm/Carbon-MRV-Prototype/stargazers) 🧩  
  *AI-assisted prototype platform for agricultural carbon accounting, practice verification, and MRV data aggregation.*

* **[GreenChain MRV & Credit Marketplace](https://github.com/Simplyaksh18/GreenChain)** [![Stars](https://img.shields.io/github/stars/Simplyaksh18/GreenChain?style=social&color=white)](https://github.com/Simplyaksh18/GreenChain/stargazers) ⛓️  
...
* **[Farm2Credit](https://github.com/gracevarshinik-stack/Farm2Credit)** [![Stars](https://img.shields.io/github/stars/gracevarshinik-stack/Farm2Credit?style=social&color=white)](https://github.com/gracevarshinik-stack/Farm2Credit/stargazers) 💡  
  *Smallholder farmer carbon credit issuance platform using satellite MRV and transparent practice verification.*

* **[MRV for SOC Regional Platform](https://github.com/climatecarbonlanduse/MRV_for_SOC_article)** [![Stars](https://img.shields.io/github/stars/climatecarbonlanduse/MRV_for_SOC_article?style=social&color=white)](https://github.com/climatecarbonlanduse/MRV_for_SOC_article/stargazers) 🇸🇪  
...
* **[FarmStack](https://github.com/FarmStack/FarmStack)** [![Stars](https://img.shields.io/github/stars/FarmStack/FarmStack?style=social&color=white)](https://github.com/FarmStack/FarmStack/stargazers) 🌐  
